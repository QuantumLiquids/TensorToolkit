...
*
* Description: QuantumLiquids/tensor project. QR for a symmetric QLTensor.
*/

/**
@file ten_qr.h
@brief QR for a symmetric QLTensor.
*/
#ifndef QLTEN_TENSOR_MANIPULATION_TEN_DECOMP_TEN_QR_H
#define QLTEN_TENSOR_MANIPULATION_TEN_DECOMP_TEN_QR_H
...
QRDataBlkInfoVecPair TensorQRExecutor<TenElemT, QNT>::CreatQRResTens_(void) {
  ...
  (*pr_) = QLTensor<TenElemT, QNT>(std::move(r_indexes));
...
#endif /* ifndef QLTEN_TENSOR_MANIPULATION_TEN_DECOMP_TEN_QR_H */
