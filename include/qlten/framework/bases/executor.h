...
*
* Description: QuantumLiquids/tensor project. Abstract base class for asynchronous
...
*/
#ifndef QLTEN_FRAMEWORK_BASES_EXECUTOR_H
#define QLTEN_FRAMEWORK_BASES_EXECUTOR_H
...
#endif /* ifndef QLTEN_FRAMEWORK_BASES_EXECUTOR_H */
