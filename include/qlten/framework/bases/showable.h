...
*
* Description: QuantumLiquids/tensor project. Abstract base class for object which need
* be format print.
*/
...
*/
#ifndef QLTEN_FRAMEWORK_BASES_SHOWABLE_H
#define QLTEN_FRAMEWORK_BASES_SHOWABLE_H
...
#endif /* ifndef QLTEN_FRAMEWORK_BASES_SHOWABLE_H */
